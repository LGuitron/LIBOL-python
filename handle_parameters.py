...
def handle_parameters():
    ...
    parser.add_argument('-d', type=str, help='Path to dataset (Default ./data/bc/breast_cancer_scale.txt)', dest='path_to_dataset', default='./data/bc/breast_cancer_scale.txt') # dataset
